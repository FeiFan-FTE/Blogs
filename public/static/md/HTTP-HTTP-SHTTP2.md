...
![在这里插入图片描述](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/cee04f528e4d48d69998646fe7ed4a4b~tplv-k3u1fbpfcp-zoom-1.image)
...
1. 先通过[域名系统（Domain Name System，DNS）](https://baike.baidu.com/item/域名系统（服务）协议/15134609?fromtitle=dns&fromid=427444)查询将域名转换为 IP 地址。即将 `test.com` 转换为 `221.239.100.30` 这一过程。
...
![在这里插入图片描述](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5b8961e91090400a99544d0ca3b15cd6~tplv-k3u1fbpfcp-zoom-1.image)
...
![在这里插入图片描述](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a466be5619594bfeb24f68bd99fed39a~tplv-k3u1fbpfcp-zoom-1.image)
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-uWP5p7So-1589532545350)(../imgs/is3.png)]](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800" height="600"></svg>)
...
由于 [TCP 慢启动机制](https://baike.baidu.com/item/慢启动/8242395)，导致每个 TCP 连接在一开始的时候传输速率都不高，在处理多个请求后，才会慢慢达到“合适”的速率。对于请求数据量很小的 HTTP 请求来说，这种情况就是种灾难。
